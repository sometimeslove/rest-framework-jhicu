...
class HL7_MESSAGE_LOGS(models.Model):
    ...
    ACTION_NAME= models.CharField('消息类型',max_length=100, blank=True,null=True, default='')
    CREATE_USER= models.CharField('创建人',max_length=100, blank=True, null=True,default='1')
    CREATE_DATE= models.DateTimeField('创建日期',auto_now_add=True)
    PATIENT_ID= models.CharField('患者ID',max_length=100, blank=True,null=True, default='1')
    VISIT_ID= models.CharField('住院次',max_length=100, blank=True,null=True, default='1')
    INP_NO= models.CharField('住院流水号',max_length=100, blank=True,null=True, default='1')
    ORDER_NO= models.CharField('医嘱主键',max_length=100, blank=True, null=True,default='1')
    RESULT= models.CharField('处理结果（0：成功  1：失败）',max_length=100, blank=True,null=True, default='1')
    class Meta:
